...
# Some changes made to support max number of checked items and settings checked
...
class CheckableComboBox(QtWidgets.QComboBox):
    ...
    def __init__(self, *args, max_checked, **kwargs):
    ...
    def addItems(self, texts, datas=None):
    ...
    def setCheckedTexts(self, texts):
        if self.checked_count:
            self.clearCheckedItems()
        for text in texts[:self.max_checked]:
