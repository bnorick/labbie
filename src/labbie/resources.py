...
class ResourceManager:
    ...
    _RESOURCES = {
        'trade_stats': Resource(version=5, path_format='pathofexile/{version}/stats.json.gz'),
        'items': Resource(version=5, path_format='pathofexile/{version}/items.json.gz'),
        'mods': Resource(version=5, path_format='repoe/{version}/mods.json.gz'),
    }
