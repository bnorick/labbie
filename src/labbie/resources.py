...
class ResourceManager:
    ...
    _RESOURCES = {
        'trade_stats': Resource(version=4, path_format='pathofexile/{version}/stats.json.gz'),
        'items': Resource(version=4, path_format='pathofexile/{version}/items.json.gz'),
        'mods': Resource(version=4, path_format='repoe/{version}/mods.json.gz'),
    }
